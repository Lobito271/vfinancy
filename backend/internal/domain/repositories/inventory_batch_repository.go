...
type InventoryBatchRepository interface {
	Create(ctx context.Context, b *inventory.InventoryBatch) error
	Update(ctx context.Context, b *inventory.InventoryBatch) error

	GetByID(ctx context.Context, id uuid.UUID) (*inventory.InventoryBatch, error)
	List(ctx context.Context, filter InventoryBatchFilter) (Page[*inventory.InventoryBatch], error)
	...
	ListClearance(ctx context.Context, companyID uuid.UUID, at time.Time) ([]*inventory.InventoryBatch, error)
}
