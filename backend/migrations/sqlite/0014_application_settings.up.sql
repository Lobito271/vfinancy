-- 0014_application_settings.up.sql (SQLite)
-- Module 2: Administration — Application Settings
-- Key-value store for company-level configuration.
-- Each setting has a category for grouping and a TEXT value holding the
-- JSON-encoded data (simple strings, numbers, booleans, or nested
-- objects) exactly as the application writes and reads it.
